...
class DelegatesExport implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithEvents
{
    use Exportable;
    ...
    {
        return view('exports.delegates', [
            'models' => Delegate::filter($this->filter)->orderBy('id', 'desc')->get()
        ]);
    }
